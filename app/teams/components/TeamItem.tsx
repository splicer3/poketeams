...
const TeamItem: React.FC<TeamItemProps> = ({ team, onClick }) => {
  ...
  return (
    <>
      <button
        className="flex flex-col 2xl:flex-row items-center gap-3 2xl:w-full 2xl:mx-6 py-4 px-6 mb-8 cool-box hover:scale-105 hover:bg-gray-200/60 dark:hover:bg-gray-700/10 active:scale-100 transition"
        onClick={handleClick}
      >
